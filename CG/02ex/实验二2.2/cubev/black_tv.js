...
function setPoints(){
	...
	//粉色小电视
	// 本体
	drawBody2(0,1,2,3,8,points,colors);  // 正面
	drawBody2(0,3,7,4,10,points,colors); 	// 左面
	drawBody2(4,5,6,7,9,points,colors);	// 后面
	drawBody2(1,5,6,2,11,points,colors);  // 右面
	drawBody2(0,4,5,1,12,points,colors);	
	drawBody2(3,7,6,2,13,points,colors);	
	
	// 上面的白杠杠
	drawUpBar2(0,1,2,3,7,points,colors); 
	drawUpBar2(0,3,7,4,7,points,colors); 
	drawUpBar2(4,5,6,7,7,points,colors);	
	drawUpBar2(1,5,6,2,7,points,colors);  
	drawUpBar2(0,4,5,1,7,points,colors);
	drawUpBar2(3,7,6,2,7,points,colors);	
	
	// 下面的白杠杠
	drawDownBar2(0,1,2,3,7,points,colors); 
	drawDownBar2(0,3,7,4,7,points,colors); 
	drawDownBar2(4,5,6,7,7,points,colors);	
	drawDownBar2(1,5,6,2,7,points,colors);  
	drawDownBar2(0,4,5,1,7,points,colors);
	drawDownBar2(3,7,6,2,7,points,colors);	
	
	// 左面的白杠杠
	drawLeftBar2(0,1,2,3,7,points,colors); 
	drawLeftBar2(0,3,7,4,7,points,colors); 
	drawLeftBar2(4,5,6,7,7,points,colors);	
	drawLeftBar2(1,5,6,2,7,points,colors);  
	drawLeftBar2(0,4,5,1,7,points,colors);
	drawLeftBar2(3,7,6,2,7,points,colors);
	
	// 右面的白杠杠
	drawRightBar2(0,1,2,3,7,points,colors); 
	drawRightBar2(0,3,7,4,7,points,colors); 
	drawRightBar2(4,5,6,7,7,points,colors);	
	drawRightBar2(1,5,6,2,7,points,colors);  
	drawRightBar2(0,4,5,1,7,points,colors);
	drawRightBar2(3,7,6,2,7,points,colors);
	
	// 左眼
	drawLeftEye2(0,1,2,3,7,points,colors); 
	drawLeftEye2(0,3,7,4,7,points,colors); 
	drawLeftEye2(4,5,6,7,7,points,colors);	
	drawLeftEye2(1,5,6,2,7,points,colors);  
	drawLeftEye2(0,4,5,1,7,points,colors);
	drawLeftEye2(3,7,6,2,7,points,colors);	
	
	// 右眼
	drawRightEye2(0,1,2,3,7,points,colors); 
	drawRightEye2(0,3,7,4,7,points,colors); 
	drawRightEye2(4,5,6,7,7,points,colors);	
	drawRightEye2(1,5,6,2,7,points,colors);  
	drawRightEye2(0,4,5,1,7,points,colors);
	drawRightEye2(3,7,6,2,7,points,colors);	
		
	// 嘴嘴上面的杠杠
	drawupMouth2(0,1,2,3,7,points,colors); 
	drawupMouth2(0,3,7,4,7,points,colors); 
	drawupMouth2(4,5,6,7,7,points,colors);	
	drawupMouth2(1,5,6,2,7,points,colors);  
	drawupMouth2(0,4,5,1,7,points,colors);
	drawupMouth2(3,7,6,2,7,points,colors);	
	
	// 左天线
	drawLeftAntenna2(0,1,2,3,7,points,colors); 
	drawLeftAntenna2(0,3,7,4,7,points,colors); 
	drawLeftAntenna2(4,5,6,7,7,points,colors);	
	drawLeftAntenna2(1,5,6,2,7,points,colors);  
	drawLeftAntenna2(0,4,5,1,7,points,colors);
	drawLeftAntenna2(3,7,6,2,7,points,colors);	
	
	// 右天线
	drawRightAntenna2(0,1,2,3,7,points,colors); 
	drawRightAntenna2(0,3,7,4,7,points,colors); 
	drawRightAntenna2(4,5,6,7,7,points,colors);	
	drawRightAntenna2(1,5,6,2,7,points,colors);  
	drawRightAntenna2(0,4,5,1,7,points,colors);
	drawRightAntenna2(3,7,6,2,7,points,colors);	
	
	// 左脚脚
	drawLeftFoot2(0,1,2,3,7,points,colors); 
	drawLeftFoot2(0,3,7,4,7,points,colors); 
	drawLeftFoot2(4,5,6,7,7,points,colors);	
	drawLeftFoot2(1,5,6,2,7,points,colors);  
	drawLeftFoot2(0,4,5,1,7,points,colors);
	drawLeftFoot2(3,7,6,2,7,points,colors);
	
	// 右脚脚
	drawRightFoot2(0,1,2,3,7,points,colors); 
	drawRightFoot2(0,3,7,4,7,points,colors); 
	drawRightFoot2(4,5,6,7,7,points,colors);	
	drawRightFoot2(1,5,6,2,7,points,colors);  
	drawRightFoot2(0,4,5,1,7,points,colors);
	drawRightFoot2(3,7,6,2,7,points,colors);
}
...
//粉色小电视本体
function drawBody2(a,b,c,d,colorIndex,points,colors){
	var bodyVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(bodyVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 上边框
function drawUpBar2(a,b,c,d,colorIndex,points,colors){
		var upBarVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(upBarVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 下边框
function drawDownBar2(a,b,c,d,colorIndex,points,colors){
		var downBarVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(downBarVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 右边框
function drawLeftBar2(a,b,c,d,colorIndex,points,colors){
		var leftBarVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(leftBarVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 左边框
function drawRightBar2(a,b,c,d,colorIndex,points,colors){
		var rightBarVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(rightBarVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 左眼
function drawLeftEye2(a,b,c,d,colorIndex,points,colors){
		var leftEyeVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(leftEyeVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 右眼
function drawRightEye2(a,b,c,d,colorIndex,points,colors){
		var rightEyeVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(rightEyeVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 嘴嘴
function drawupMouth2(a,b,c,d,colorIndex,points,colors){
		var upMouthVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(upMouthVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 左天线
function drawLeftAntenna2(a,b,c,d,colorIndex,points,colors){
		var leftAntennaVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(leftAntennaVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 右天线
function drawRightAntenna2(a,b,c,d,colorIndex,points,colors){
		var leftAntennaVer=[
...
// 右脚脚
function drawLeftFoot2(a,b,c,d,colorIndex,points,colors){
		var leftFootVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(leftFootVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}

// 左脚脚
function drawRightFoot2(a,b,c,d,colorIndex,points,colors){
		var rightFootVer=[
	...
	var indices=[a,b,c,a,c,d];
	for(var i=0;i<indices.length;i++){
		points2.push(rightFootVer[indices[i]]);
		colors2.push(chooseColors[colorIndex]);
	}
}
