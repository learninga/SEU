...
function drawUpBar(pointArray,normalArray){
	...
	quad(upBarVer,0,3,2,1,pointArray,normalArray);
	quad(upBarVer,0,4,7,3,pointArray,normalArray);
	quad(upBarVer,4,5,6,7,pointArray,normalArray);
	quad(upBarVer,1,2,6,5,pointArray,normalArray);
	quad(upBarVer,0,1,5,4,pointArray,normalArray);
...
function drawUpBar2(pointArray,normalArray){
	...
	quad(upBarVer2,0,3,2,1,pointArray,normalArray);
	quad(upBarVer2,0,4,7,3,pointArray,normalArray);
	quad(upBarVer2,4,5,6,7,pointArray,normalArray);
	quad(upBarVer2,1,2,6,5,pointArray,normalArray);
	quad(upBarVer2,0,1,5,4,pointArray,normalArray);
...
function drawDownBar(pointArray,normalArray){
	...
	quad(downBarVer,0,3,2,1,pointArray,normalArray);
	quad(downBarVer,0,4,7,3,pointArray,normalArray);
	quad(downBarVer,4,5,6,7,pointArray,normalArray);
	quad(downBarVer,1,2,6,5,pointArray,normalArray);
	quad(downBarVer,0,1,5,4,pointArray,normalArray);
...
function drawDownBar2(pointArray,normalArray){
	...
	quad(downBarVer2,0,3,2,1,pointArray,normalArray);
	quad(downBarVer2,0,4,7,3,pointArray,normalArray);
	quad(downBarVer2,4,5,6,7,pointArray,normalArray);
	quad(downBarVer2,1,2,6,5,pointArray,normalArray);
	quad(downBarVer2,0,1,5,4,pointArray,normalArray);
...
function drawLeftBar(pointArray,normalArray){
	...
	quad(leftBarVer,0,3,2,1,pointArray,normalArray);
	quad(leftBarVer,0,4,7,3,pointArray,normalArray);
	quad(leftBarVer,4,5,6,7,pointArray,normalArray);
	quad(leftBarVer,1,2,6,5,pointArray,normalArray);
	quad(leftBarVer,0,1,5,4,pointArray,normalArray);
...
function drawLeftBar2(pointArray,normalArray){
	...
	quad(leftBarVer2,0,3,2,1,pointArray,normalArray);
	quad(leftBarVer2,0,4,7,3,pointArray,normalArray);
	quad(leftBarVer2,4,5,6,7,pointArray,normalArray);
	quad(leftBarVer2,1,2,6,5,pointArray,normalArray);
	quad(leftBarVer2,0,1,5,4,pointArray,normalArray);
...
function drawRightBar(pointArray,normalArray){
	...
	quad(rightBarVer,0,3,2,1,pointArray,normalArray);
	quad(rightBarVer,0,4,7,3,pointArray,normalArray);
	quad(rightBarVer,4,5,6,7,pointArray,normalArray);
	quad(rightBarVer,1,2,6,5,pointArray,normalArray);
	quad(rightBarVer,0,1,5,4,pointArray,normalArray);
...
function drawRightBar2(pointArray,normalArray){
	...
	quad(rightBarVer2,0,3,2,1,pointArray,normalArray);
	quad(rightBarVer2,0,4,7,3,pointArray,normalArray);
	quad(rightBarVer2,4,5,6,7,pointArray,normalArray);
	quad(rightBarVer2,1,2,6,5,pointArray,normalArray);
	quad(rightBarVer2,0,1,5,4,pointArray,normalArray);
...
function drawLeftEye(pointArray,normalArray){
	...
	quad(leftEyeVer,0,3,2,1,pointArray,normalArray);
	quad(leftEyeVer,0,4,7,3,pointArray,normalArray);
	quad(leftEyeVer,4,5,6,7,pointArray,normalArray);
	quad(leftEyeVer,1,2,6,5,pointArray,normalArray);
	quad(leftEyeVer,0,1,5,4,pointArray,normalArray);
...
function drawLeftEye2(pointArray,normalArray){
	...
	quad(leftEyeVer2,0,3,2,1,pointArray,normalArray);
	quad(leftEyeVer2,0,4,7,3,pointArray,normalArray);
	quad(leftEyeVer2,4,5,6,7,pointArray,normalArray);
	quad(leftEyeVer2,1,2,6,5,pointArray,normalArray);
	quad(leftEyeVer2,0,1,5,4,pointArray,normalArray);
...
function drawRightEye(pointArray,normalArray){
	...
	quad(rightEyeVer,0,3,2,1,pointArray,normalArray);
	quad(rightEyeVer,0,4,7,3,pointArray,normalArray);
	quad(rightEyeVer,4,5,6,7,pointArray,normalArray);
	quad(rightEyeVer,1,2,6,5,pointArray,normalArray);
	quad(rightEyeVer,0,1,5,4,pointArray,normalArray);
...
function drawRightEye2(pointArray,normalArray){
	...
	quad(rightEyeVer2,0,3,2,1,pointArray,normalArray);
	quad(rightEyeVer2,0,4,7,3,pointArray,normalArray);
	quad(rightEyeVer2,4,5,6,7,pointArray,normalArray);
	quad(rightEyeVer2,1,2,6,5,pointArray,normalArray);
	quad(rightEyeVer2,0,1,5,4,pointArray,normalArray);
...
function drawupMouth(pointArray,normalArray){
	...
	quad(upMouthVer,0,3,2,1,pointArray,normalArray);
	quad(upMouthVer,0,4,7,3,pointArray,normalArray);
	quad(upMouthVer,4,5,6,7,pointArray,normalArray);
	quad(upMouthVer,1,2,6,5,pointArray,normalArray);
	quad(upMouthVer,0,1,5,4,pointArray,normalArray);
...
function drawupMouth2(pointArray,normalArray){
	...
	quad(upMouthVer2,0,3,2,1,pointArray,normalArray);
	quad(upMouthVer2,0,4,7,3,pointArray,normalArray);
	quad(upMouthVer2,4,5,6,7,pointArray,normalArray);
	quad(upMouthVer2,1,2,6,5,pointArray,normalArray);
	quad(upMouthVer2,0,1,5,4,pointArray,normalArray);
...
function drawRightFoot(pointArray,normalArray){
	...
	quad(rightFootVer,0,3,2,1,pointArray,normalArray);
	quad(rightFootVer,0,4,7,3,pointArray,normalArray);
	quad(rightFootVer,4,5,6,7,pointArray,normalArray);
	quad(rightFootVer,1,2,6,5,pointArray,normalArray);
	quad(rightFootVer,0,1,5,4,pointArray,normalArray);
...
function drawRightFoot2(pointArray,normalArray){
	...
	quad(rightFootVer2,0,3,2,1,pointArray,normalArray);
	quad(rightFootVer2,0,4,7,3,pointArray,normalArray);
	quad(rightFootVer2,4,5,6,7,pointArray,normalArray);
	quad(rightFootVer2,1,2,6,5,pointArray,normalArray);
	quad(rightFootVer2,0,1,5,4,pointArray,normalArray);
...
function render()
{
	...
	//modelViewMatrix = mult(mult(mult(T, R), S), init);
    ...
    materialDiffuse = vec4( 0.5, 1.0, 0.5, 1.0);
...
//     gl.vertexAttribPointer(vColor2, 4, gl.FLOAT, false, 0, 0);
	...
	//设置材质
	materialAmbient=vec4( 0.8, 0.6, 0.4, 1.0 );
	materialDiffuse = vec4( 0.8, 0.0, 0.5, 1.0);
